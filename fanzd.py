...
2. Include comprehensive comments that explain:
   - The overall approach and algorithm used
   - How each function/method implements the problem requirements
   - Edge cases handled and why they are important
   - Input validation logic and error handling
   - Time/space complexity considerations where relevant
...
8. Comments should demonstrate understanding of the problem requirements and show how the code addresses each aspect.

Comment Requirements:
- Each function should have a docstring explaining its purpose, parameters, return value, and any exceptions it might raise
- Inline comments should explain complex logic, edge case handling, and non-obvious implementation choices
- Explain how the solution handles boundary conditions, empty inputs, invalid inputs, and other edge cases
- Show how the implementation fulfills all aspects of the problem statement
- Comments should be detailed enough that someone unfamiliar with the problem can understand the approach

Return only the final python files code with comprehensive explanatory comments.
...
def process_create_task(input_dict):
    ...
    problem_statement, _ = post_process_instruction(problem_statement)
    ...
    # Extract and write files from testcases
